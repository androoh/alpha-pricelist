...
class GeneratePdf implements ShouldQueue, ShouldBeUnique
{
    ...
    public $apiUrl;
    public $language = 'en';
    public $cmd = "PAGEDJS_CLI 'APP_URL/api/resources/priceList/PRICELIST_ID/html?path=&template=pricelist&locale=LANGUAGE&pageSize=A4&showCropBorders=false&showCross=false&pageOrientation=portrait' -o ./storage/app/pdf/pricelist-LANGUAGE-PRICELIST_ID.pdf -t 600000 --additional-script './pagedjs-handlers.js'";
