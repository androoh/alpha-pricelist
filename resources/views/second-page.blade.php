...
@endphp
<div class="second-page" @if ($secondPagePhoto && data_get($secondPagePhoto, '0.name', null))style="background-image: url('/imgc/a4mw/{{ data_get($secondPagePhoto, '0.name', null) }}')"@endif>
    <div class="page-info">
